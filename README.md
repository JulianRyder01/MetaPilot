...
> 版本 **1.0.0** · 交互式学习网站 · 课程学习 / 个人笔记 / 个人知识库
...
- **库**：基础结构是「库 → 文档集 → 文档 → 小节」，课程只是其中一种文档集类型；还支持导入 Markdown / Obsidian 笔记作为个人知识库，并用 AI 向量问答 + 文档溯源。
...
| 个人知识库插件 | 向量编码本地小节，AI 提问并溯源到具体文档（docs/05） |
